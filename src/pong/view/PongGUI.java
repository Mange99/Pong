...
public class PongGUI extends Application implements IEventHandler {
    ...
    private void newGame() {
        ...
        pong = new Pong(
                new Ball(GAME_WIDTH / 2 - Ball.WIDTH / 2, GAME_HEIGHT / 2 - Ball.HEIGHT / 2,
                        new Random().nextBoolean()? 1 : -1 ,new Random().nextBoolean()? 1 : -1, Ball.STARTSPEED),
                new Paddle(GAME_WIDTH - Paddle.PADDLE_WIDTH - 5, GAME_HEIGHT / 2 - Paddle.PADDLE_HEIGHT / 2,
                        0, 0, PADDLE_SPEED),
                new Paddle(5, GAME_HEIGHT / 2 - Paddle.PADDLE_HEIGHT / 2,
                        0, 0, PADDLE_SPEED),
                new Ceiling(0), new Floor(GAME_HEIGHT)
        );
